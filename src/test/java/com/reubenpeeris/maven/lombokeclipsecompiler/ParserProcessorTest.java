...
public class ParserProcessorTest {
	...
	public void verifyMessageBeforeSpacerComesOut() throws IOException {
		assertProcessorOutput(NON_PARSEABLE_MESSAGE + SPACER, Collections.<CompilerMessage>emptyList(), Arrays.asList(new Message(Logger.LEVEL_INFO, NON_PARSEABLE_MESSAGE)));
	}
